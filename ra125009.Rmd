...
modelo <- lm(pH ~ AcidoCitrico + AcidezFixa + AcucarResidual + Cloreto + DioxidoEnxofreTotal + Densidade + Sulfato + Alcool + DioxidoEnxofreLivre, data = df2)
summary(modelo)
